# PRODUCT SCOPE — FLASH CLINIC (NON-NEGOTIABLE)

Flash Clinic is a 30-day MVP for small dental clinics (1–3 dentists).

## Core Goal
Reduce manual WhatsApp messages and prevent lost appointments.

## STRICT SCOPE
- Single channel: WhatsApp
- Single flow: message → patient registration → appointment → daily dashboard
- Single dashboard: "Today's Appointments"

## IN SCOPE
- Patient registration (name, WhatsApp, reason)
...
## Decision Rule
If it does not reduce manual WhatsApp work or prevent lost appointments,
